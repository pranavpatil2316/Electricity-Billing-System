...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        ImageIcon iconDelete = new ImageIcon(ClassLoader.getSystemResource("icon/delete.png")); 
        deleteCustomer.setIcon(new ImageIcon(iconDelete.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT)));
        deleteCustomer.setMnemonic('X');
        deleteCustomer.addActionListener(this);
        deleteCustomer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
